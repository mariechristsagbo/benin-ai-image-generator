    ...
    return (
        ...
        <main className='text-white h-screen bg-no-repeat bg-cover bg-[url("https://s.rfi.fr/media/display/dfedfd3a-3f03-11ed-81a9-005056bf30b7/w:1280/p:16x9/000_32JN7YL.jpg")]'>
            <div className=' bg-black bg-opacity-40 h-screen w-full'>
                ...
                <h1 className='text-3xl font-bold max-w-[14em] lg:text-4xl'>The Future of Chat is Here With AI Technology</h1>
                    <p className='max-w-[50em] lg:text-lg xl:text-2xl'>Generating culturally relevant images from local languages such as Fon and Yoruba, to improve cultural accessibility and preservation of Benin's languages.</p>
